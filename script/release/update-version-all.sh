...
updateParentVersion() {
    mvn -B -Dfull versions:update-parent -N -DparentVersion=[$newVersion] -DallowSnapshots=true -DgenerateBackupPoms=false
}

updateChildModulesVersion() {
    mvn -B -Dfull versions:update-child-modules -DallowSnapshots=true -DgenerateBackupPoms=false
}
